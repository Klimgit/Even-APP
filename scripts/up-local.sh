...
start auth \
  "HTTP_PORT=8081 DATABASE_URL='${AUTH_DATABASE_URL}' JWT_SECRET='${JWT_SECRET}' \
   CONTENT_DATABASE_URL='${CONTENT_DATABASE_URL}' LEARNING_DATABASE_URL='${LEARNING_DATABASE_URL}' \
   LEXICON_DATABASE_URL='${LEXICON_DATABASE_URL}' LOG_LEVEL='${LOG_LEVEL:-info}' ./bin/auth"
start media \
...
start lexicon \
  "HTTP_PORT=8082 DATABASE_URL='${LEXICON_DATABASE_URL}' MEDIA_DATABASE_URL='${MEDIA_DATABASE_URL}' LOG_LEVEL='${LOG_LEVEL:-info}' ./bin/lexicon"
start content \
