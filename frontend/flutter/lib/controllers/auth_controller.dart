...
class AuthController extends GetxController {
  ...
  // Role helpers. Roles mirror the web admin panel: 'admin', 'instructor',
  // 'student'. Missing/unknown role is treated as 'student'.
  String get role => (userData['role'] as String?) ?? 'student';
  bool get isAdmin => role == 'admin';
  bool get isInstructor => role == 'instructor';

  // TODO(temporary): hard-coded teacher override for testing without editing
  // Firestore. Remove once roles are assigned in the `users` collection.
  static const Set<String> _teacherOverrideEmails = {
    'egorrussian56@gmail.com',
  };

  bool get isTeacher =>
      isInstructor ||
      isAdmin ||
      _teacherOverrideEmails.contains(currentUser?.email?.toLowerCase());
